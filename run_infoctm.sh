...
# InfoCTM on Amazon_Review (weight_MI: 50.0) with 2 refinement loops
...
# InfoCTM on ECNews (weight_MI: 30.0) with 2 refinement loops
...
# InfoCTM on Rakuten_Amazon (weight_MI: 50.0) with 2 refinement loops
