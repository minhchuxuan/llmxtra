...
python3 main.py --model InfoCTM --seed 0 --dataset Amazon_Review --device 1 --gemini_api_key  \
...
python3 main.py --model InfoCTM --seed 0 --dataset ECNews --device 1 --gemini_api_key \
    --refine_frequency 8 --refine_weight 20000 --topic_sim_weight 100 --enable_phase3

# InfoCTM on Rakuten_Amazon (weight_MI: 50.0)
echo "=== Running InfoCTM on Rakuten_Amazon ==="
python3 main.py --model InfoCTM --seed 7 --dataset Rakuten_Amazon --device 1 --gemini_api_key\
    --refine_frequency 8 --refine_weight 20000 --topic_sim_weight 100 --enable_phase3
